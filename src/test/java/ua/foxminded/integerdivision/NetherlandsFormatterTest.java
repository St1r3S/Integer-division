...
class NetherlandsFormatterTest {
    Formatter formatter = FormatterFactory.getInstance().get("Netherlands Formatter");
    ...
    void shouldVerifyLargePositiveDividendAndLargePositiveDivisor() {
        ...
        assertEquals("6514 / 51654123 \\ 7929\n" +
                        "       45598\n" +
                        "       -----\n" +
                        "        60561\n" +
                        "        58626\n" +
